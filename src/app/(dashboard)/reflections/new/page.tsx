...
import {programsApi, reflectionsApi} from "@/lib/api-client";
...
export default function ReflectionNewPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            alert(error instanceof Error ? error.message : "Gagal membuat refleksi");
        } finally {
            setSaving(false);
        }
    };
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-slate-900">Tambah Refleksi</h1>
                    <p className="text-slate-500 mt-1">Buat refleksi baru untuk program yang diikuti</p>
                </div>
            </div>
